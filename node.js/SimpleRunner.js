...
SimpleRunner.prototype.run = function ( program, processorDefinition, maxCycles) {
	
	var processor = new InterpretedProcessor( processorDefinition );
	
	var state = new State( processor );
